    ...
    protected void checkServiceInterface() throws IllegalArgumentException {
        ...
        if (!serviceInterface.isInstance(service)) {
            throw new IllegalArgumentException("Service interface [" +
                ...
                "] needs to be implemented by service [" + service +
                "] of class [" + service.getClass().getName() + "]");
        }
    }
    ...
    */
    protected Object getProxyForService() {
        ...
        if ((this.registerTraceInterceptor != null)
                ? this.registerTraceInterceptor.booleanValue()
        ...
        if (this.interceptors != null) {
            ...
            for (int i = 0; i < this.interceptors.length; i++) {
                proxyFactory.addAdvisor(adapterRegistry.wrap(
                        this.interceptors[i]));
            }
        }
