...
public class HttpComponentsHttpInvokerRequestExecutor
    ...
    */
    protected HttpPost createHttpPost(HttpInvokerClientConfiguration config)
        ...
        if (locale != null) {
            httpPost.addHeader(HTTP_HEADER_ACCEPT_LANGUAGE,
    ...
    */
    protected void setRequestBody(HttpInvokerClientConfiguration config,
        HttpPost httpPost, ByteArrayOutputStream baos)
        throws IOException {
...
//            httpPost.setEntity(entity);
    ...
    */
    protected InputStream getResponseBody(
        HttpInvokerClientConfiguration config, HttpResponse httpResponse)
        throws IOException {
