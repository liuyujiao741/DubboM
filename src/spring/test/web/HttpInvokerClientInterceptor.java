...
import spring.test.RemoteInvocationBasedAccessor;
...
public class HttpInvokerClientInterceptor extends RemoteInvocationBasedAccessor
    ...
    */
    ...
    public Object invoke(MethodInvocation methodInvocation)
        ...
        try {
            Object obj=recreateRemoteInvocationResult(result);
            return obj;
        } catch (Throwable ex) {
    ...
    */
    protected RemoteAccessException convertHttpInvokerAccessException(
        Throwable ex) {
